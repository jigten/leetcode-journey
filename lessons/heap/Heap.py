    ...
    def pop(self):
        ...
        if self.realSize < 1:
            ...
            while index <= self.realSize // 2:
                ...
                if (
                    self.minheap[index] > self.minheap[left]
                    or self.minheap[index] > self.minheap[right]
                ):
                    if self.minheap[left] < self.minheap[right]:
                        self.minheap[left], self.minheap[index] = (
                            self.minheap[index],
                            self.minheap[left],
                        )
                        index = left
                    else:
                        self.minheap[right], self.minheap[index] = (
                            self.minheap[index],
                            self.minheap[right],
                        )
                        index = right
    ...
    def pop(self):
        ...
        if self.realSize < 1:
            ...
            while index <= self.realSize // 2:
                ...
                # of the left and right child
                if (
                    self.maxheap[index] < self.maxheap[left]
                    or self.maxheap[index] < self.maxheap[right]
                ):
                    if self.maxheap[left] > self.maxheap[right]:
                        self.maxheap[left], self.maxheap[index] = (
                            self.maxheap[index],
                            self.maxheap[left],
                        )
                        index = left
                    else:
                        self.maxheap[right], self.maxheap[index] = (
                            self.maxheap[index],
                            self.maxheap[right],
                        )
                        index = right
